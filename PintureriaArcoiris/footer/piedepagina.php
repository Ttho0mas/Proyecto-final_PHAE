...
<footer class="cont-footer">
    <div class="footer-contenido">
        ...
        <div class="footer-links">
            ...
            <div class="footer-seccion">
                 <h3 class="titulo-seccion">Ayuda</h3>
                <span class="footer-info"><a href="#" class="footer-link">Términos y condiciones</a></span>
                <span class="footer-info"><a href="#" class="footer-link">Preguntas frecuentes</a></span>
            </div>
        </div>
    </div>
  <br>
