    ...
    <main>
        ...
        <div class="seccion-subcategoria">
            <div class="subcategoria">
               <a href="/pintureria/index.php">  <div class="colorcont"></div></a>
               <p>Pintura para paredes interiores</p>
            </div>

            <div class="subcategoria">
                <a href="/pintureria/index.php"> <div class="colorcont"></div></a>
                 <p>Pintura para paredes exteriores</p>
            </div>
        ...
        <div class="seccion-subcategoria">
            <div class="subcategoria">
                <a href="/pintureria/index.php"> <div class="colorcont"></div></a>
                <p>Protectores de madera y barnices</p>
            </div>

            <div class="subcategoria">
                <a href="/pintureria/index.php">  <div class="colorcont"></div></a>
                <p>Pintura para pisos</p>
            </div>
        ...
        <div class="seccion-subcategoria">
            <div class="subcategoria">
                <a href="/pintureria/index.php"> <div class="colorcont"></div></a>
                <p>Fijadores, fondos, y selladores</p>
            </div>
